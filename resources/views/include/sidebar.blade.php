<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
      ...
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
        ...
        <li class="bold"><a href="/mutabaah/lihat"><i class="material-icons">book</i><span class="menu-title" data-i18n="Templates">Mutaba'ah</span></a>
        </li>
        ...
        <li class="bold"><a href="/kelas/lihat"><i class="material-icons">dvr</i><span class="menu-title" data-i18n="Templates">Kelas</span></a>
        </li>
        ...
        <li class="bold"><a href="JavaScript:void(0)"><i class="material-icons">person_add</i><span class="menu-title" data-i18n="Templates">Register</span></a>
        </li>
